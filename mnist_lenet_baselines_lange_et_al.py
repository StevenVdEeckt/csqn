...
Net = lambda: model.get_net(neural_net, [n_classes] * n_tasks, n_channels=1)
net, shared_layers = model.get_net(neural_net, [n_classes] * n_tasks, return_shared_layers=True, n_channels=1)
